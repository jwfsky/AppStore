package store.yifan.cn.basework.http.image;
...
import store.yifan.cn.basework.manager.ThreadManager;
import store.yifan.cn.basework.utils.DrawableUtils;
...
import store.yifan.cn.basework.utils.SystemUtils;
...
public class ImageLoader {
    ...
    public static void load(ImageView view, String url) {
        ...
        if (drawable != null) {
            ...
            view.setImageResource(R.drawable.ic_drawer_shadow);//如果没加载到，设置默认图片，并异步加载
            asyncLoad(view, url);
        }
    }
